...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      {/* Mobile sidebar */}
      <div className="top-0 w-full bg-secondary-dark-blue flex flex-col md:hidden relative z-50">
        {/* Hamburger menu */}
        ...
        <div
          ref={mobileMenuRef}
          className="hidden md:hidden mobile-menu left-0 py-3 animate-slideInFromTop w-screen bg-primary-dark-blue"
        >
      ...
      {/* Normal sidebar */}
      <div className="fixed top-0 bg-primary-dark-blue h-screen w-60 shadow-lg text-white text-center flex flex-col items-center py-5 hidden md:block">
        {/*Logo*/}
        <Image alt="Logo" src={Logo} />
